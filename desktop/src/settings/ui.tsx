...
export function StatChip({
    ...
    return (
        <div className="flex flex-col gap-1 px-3 py-3">
            ...
            <span className="text-xl font-bold text-zinc-800 dark:text-zinc-200 tabular-nums leading-none">
                {value}
            </span>
...
export function Card({ children }: { children: React.ReactNode }) {
    return (
        <div className="bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-700 divide-y divide-zinc-100 dark:divide-zinc-700 overflow-hidden">
            {children}
        </div>
    )
}
...
export function SectionTitle({ children }: { children: React.ReactNode }) {
    return (
        <div className="flex items-center gap-2 mb-1">
            ...
            <h2 className="text-[11px] font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest">
                {children}
            </h2>
        </div>
    )
